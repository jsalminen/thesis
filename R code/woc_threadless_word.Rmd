...
The distribution of average scores (solid black line) appears to follow closely normal distribution with same mean and standard deviations (dashed red line).
...
normal distribution (dashed red line). Median is a better summary than mean for 
this distribution.
...
ggplot(threadless) + 
    ...
    scale_color_manual(values = c('Not printed' = 'gray', 'Printed' = 'red'), 
